...
export default function Hero() {
  return (
    <section className="relative w-full min-h-screen flex items-center bg-surface hero-gradient overflow-hidden">
      {/* Marble Texture Overlay */}
      <div className="absolute inset-0 marble-texture pointer-events-none mix-blend-overlay"></div>

      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 w-full max-w-[1440px] mx-auto px-12 pt-32 pb-20 relative z-10 items-center">
        {/* Left Content (7 cols) */}
