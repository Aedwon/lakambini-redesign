        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-16 md:gap-32 items-start">
          ...
          <div className="md:col-span-6 flex flex-col gap-8">
            <div className="space-y-6 text-on-surface-variant body-lg leading-relaxed font-light">
              <p>
                Founded in 2014 in Cavite, Lakambini began with a singular focus: to solve the complex coordination challenges that plague high-stakes productions. We saw hosts juggling an army of vendors while losing the ability to be present at their own masterpieces.
              </p>
              <p>
